 ...
 */
export async function sendClarificationToSlack(questions, payload, env) {
 ...
 */
export async function notifyPRCreated(payload, result, prResult, branch, env) {
 ...
 */
export async function notifyFollowUpCompleted(payload, result, env) {
 ...
 * 에러 알림을 Slack에 전송합니다
 */
export async function notifyError(payload, error, env) {
 ...
 */
async function postSlackMessage(payload, token) {
