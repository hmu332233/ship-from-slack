...
import type { EnvConfig, ExecuteResult, CostInfo } from "../types.js";
import { buildExecuteSystemPrompt, buildExecuteUserPrompt } from "../prompts/execute-prompt.js";

export async function runExecute(env: EnvConfig): Promise<ExecuteResult> {
...
function parseExecuteResult(raw: unknown, cost: CostInfo): ExecuteResult {
  ...
  return {
    ...
    pr_type: result.pr_type as ExecuteResult["pr_type"],
